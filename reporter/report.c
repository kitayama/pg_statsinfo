...
report_instance_activity(PGconn *conn, ReportScope *scope, FILE *out)
{
	...
	fprintf(out, "Written Buffers By BGWriter (Average) : %s KiB/s\n", PQgetvalue(res, 0, 0));
	fprintf(out, "Written Buffers By BGWriter (Maximum) : %s KiB/s\n", PQgetvalue(res, 0, 1));
	fprintf(out, "Written Buffers By Backend (Average)  : %s KiB/s\n", PQgetvalue(res, 0, 2));
	fprintf(out, "Written Buffers By Backend (Maximum)  : %s KiB/s\n", PQgetvalue(res, 0, 3));
